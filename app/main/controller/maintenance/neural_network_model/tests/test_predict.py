from packages.neural_network_model.neural_network_model import __version__ as _version
from packages.neural_network_model.neural_network_model.predict import (make_single_prediction)
